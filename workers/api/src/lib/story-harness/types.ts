...
export const FIRST_CHAPTER_HARNESS_PROMPT_VERSION = 'first-chapter-harness@2026-06-25-C';
export const FIRST_CHAPTER_HARNESS_MODEL = 'anthropic/claude-opus-4.7';
export const NEXT_CHAPTER_HARNESS_PROMPT_VERSION = 'next-chapter-harness@2026-06-25-C';
